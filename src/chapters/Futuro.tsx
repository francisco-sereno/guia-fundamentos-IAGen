...
import { Cpu, Layers, Zap, Brain, Radio, ShieldAlert, HelpCircle } from 'lucide-react';
...
export const FuturoContent = () => (
  <div className="prose-custom">
    ...
    <h2 id="sec-futuro-0" className="text-2xl font-bold mb-4 text-indigo-800 dark:text-indigo-300 scroll-mt-24 flex items-center gap-2">
      <Cpu size={24} /> 1. Hacia una inteligencia general e integrada
    </h2>
    ...
    <Accordion title="Arquitectura AGI integrada" icon={Layers}>
    ...
    <h2 id="sec-futuro-1" className="text-2xl font-bold mt-12 mb-4 text-indigo-800 dark:text-indigo-300 scroll-mt-24 flex items-center gap-2">
      <Zap size={24} /> 2. Desafíos en el escalado de la IA
    </h2>
    ...
    <div className="grid md:grid-cols-2 gap-6 my-8">
      <InfoCard type="idea" title="Límites del hardware">
          <p className="text-sm text-slate-700 dark:text-slate-300">La ley de Moore se ralentiza mientras que la demanda de cómputo para IA crece exponencialmente. El futuro depende de chips especializados y, posiblemente, computación cuántica.</p>
      </InfoCard>
      <InfoCard type="idea" title="Escasez de datos">
          <p className="text-sm text-slate-700 dark:text-slate-300">Estamos agotando los datos públicos de alta calidad en internet. La IA del futuro deberá aprender de datos sintéticos o mediante métodos más eficientes.</p>
      </InfoCard>
    </div>
    ...
    <Accordion title="Nuevos paradigmas de aprendizaje" icon={Layers}>
      <div className="space-y-4">
    ...
    <Accordion title="Cognición vs. conciencia" icon={Brain}>
      <div className="space-y-4">
    ...
    <Accordion title="La singularidad tecnológica" icon={Radio}>
    ...
    <h2 id="sec-futuro-5" className="text-2xl font-bold mt-12 mb-4 text-indigo-800 dark:text-indigo-300 scroll-mt-24 flex items-center gap-2">
      <ShieldAlert size={24} /> 6. Impacto, responsabilidad y riesgos
    </h2>
    ...
    <div className="space-y-4">
      <InfoCard type="reflexion" title="Riesgos únicos">
        <ul className="space-y-3">
          ...
          <li><strong>Impacto en las profesiones:</strong> Potencial de desplazar la riqueza del trabajo al capital, exacerbando la desigualdad.</li>
        </ul>
      </InfoCard>

      <InfoCard type="reflexion" title="Perspectiva ética con DECIDE-IA y PotencIA">
        <p>Frente al avance de la inteligencia artificial general y los riesgos de opacidad o desempleo tecnológico, el <GlossaryTerm term="DECIDE-IA"><strong>Marco DECIDE-IA</strong></GlossaryTerm> y el <GlossaryTerm term="PotencIA"><strong>Marco PotencIA</strong></GlossaryTerm> constituyen una hoja de ruta ética esencial. Ofrecen al <GlossaryTerm term="Docente de educación secundaria"><strong>docente de educación secundaria</strong></GlossaryTerm> las bases para formar ciudadanos críticos, capaces de ejercer una ciudadanía digital responsable en un entorno en constante cambio.</p>
      </InfoCard>
    </div>
    ...
    <h2 id="sec-futuro-6" className="text-2xl font-bold mt-12 mb-6 text-indigo-800 dark:text-indigo-300 scroll-mt-24 flex items-center gap-2">
    ...
    <div className="bg-slate-100 dark:bg-slate-800/50 p-6 rounded-2xl border border-slate-200 dark:border-slate-700">
      <ul className="list-decimal list-inside space-y-3 text-slate-700 dark:text-slate-300">
        ...
        <li>¿Cómo podemos prepararnos hoy para un sector educativo donde la IA sea un colaborador autónomo en lugar de una simple herramienta?</li>
      </ul>
    </div>
  </div>
);
