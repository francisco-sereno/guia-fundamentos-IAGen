...
export const FuturoContent = () => (
  <div className="prose-custom">
    ...
    <h2 id="sec-4-0" className="text-2xl font-bold mb-4 text-indigo-400 scroll-mt-24">🚀 Hacia una inteligencia general e integrada</h2>
    ...
    <h2 id="sec-4-1" className="text-2xl font-bold mt-12 mb-4 text-indigo-400 scroll-mt-24">🤖 El "momento PC" de la robótica</h2>
    ...
    <h2 id="sec-4-2" className="text-2xl font-bold mt-12 mb-4 text-indigo-400 scroll-mt-24">🧠 Desafíos de escala y representación</h2>
    ...
    <h2 id="sec-4-3" className="text-2xl font-bold mt-12 mb-4 text-indigo-400 scroll-mt-24">🧠 Transición neurológica: la cognición versus la consciencia artificial</h2>
    ...
    <h2 id="sec-4-4" className="text-2xl font-bold mt-12 mb-4 text-indigo-400 scroll-mt-24">🌌 El horizonte final de eventos: inteligencia artificial general y la singularidad tecnológica</h2>
    ...
    <h2 id="sec-4-5" className="text-2xl font-bold mt-12 mb-4 text-indigo-400 scroll-mt-24">🏗️ De la alquimia a la ingeniería de sistemas</h2>
    ...
    <h2 id="sec-4-6" className="text-2xl font-bold mt-12 mb-4 text-indigo-400 scroll-mt-24">🛡️ Impacto, responsabilidad y riesgos</h2>
